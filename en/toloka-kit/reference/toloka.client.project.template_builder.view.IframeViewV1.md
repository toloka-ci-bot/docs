# IframeViewV1
`toloka.client.project.template_builder.view.IframeViewV1` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.3/src/client/project/template_builder/view.py#L198)
