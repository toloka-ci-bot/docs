# get_apps
`toloka.async_client.client.AsyncTolokaClient.get_apps` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.3/src/client/__init__.py#L0)
...
* **Yield type:**
  ...
  [AsyncGenAdapter](toloka.util.async_utils.AsyncGenAdapter.md)\[[BaseApp](toloka.client.app.BaseApp.md), None\]
